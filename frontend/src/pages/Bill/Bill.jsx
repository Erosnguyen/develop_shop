          ...
          <form action="" className="flex flex-col gap-4">
            {
              isUser == false && (
                <>
                  <Input onChange={handleChange} isRequired name="first_name" type="text" label="First Name" />
                  <Input onChange={handleChange} isRequired name="last_name" type="text" label="Last Name" />
                  <Input onChange={handleChange} isRequired name="email" type="email" label="Email" />
                </>
              )
            }
            <Input onChange={handleChange} isRequired name="street" type="text" label="Street" />
            <Input onChange={handleChange} isRequired name="city"  type="text" label="City" />
            <Input onChange={handleChange} isRequired name="state" type="text" label="State" />
            <Input onChange={handleChange} isRequired name="country" type="text" label="Country" />
