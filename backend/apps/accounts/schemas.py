...
class ValidatePasswordInSchema(BaseModel):
    ...
    def validate_password(cls, password: str):
        return PasswordManager.validate_password_strength(
            password=password, has_special_char=False
        )
...
""",
                    "value": {"request_type": "string", "email": "user@example.com"},
                },
                "register": {
                    "summary": "Resend OTP for User Registration",
                    "value": {"request_type": "register", "email": "user@example.com"},
                },
                "reset-password": {
