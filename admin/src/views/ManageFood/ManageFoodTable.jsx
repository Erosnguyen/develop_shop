                        ...
                        {data?.map((product, index) => (
                            <TableRow key={index}>
                                ...
                                <TableCell>
                                    ...
                                    >
                                        <Box sx={{ mr: 1 }}>
                                            <img style={{ width: 50, height: 50 }} src={product?.media?.length ? product?.media[0]?.src : ""} />
                                        </Box>
                                        <Box>
                                ...
                                <TableCell style={{ width: 300 }}>
                                    <Typography style={{ width: 300, overflow: "scroll" }} color="textSecondary" variant="subtitle2" fontWeight={400}>
                                        {product?.description}
                                    </Typography>
                                </TableCell>
                                <TableCell>
